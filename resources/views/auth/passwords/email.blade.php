            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="background: url('/assets/img/forgot_password.jpg'); background-position: center; background-repeat: no-repeat; background-size: 70% 100%;"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    @if (session('status'))
                                        <h6 class="text-center text-success font-weight-bold">{{ session('status') }}</h6>
                                    @endif
                                    <br>
                                    <form class="user" method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <button type="submit" class="customButton">{{ __('Send Password Link') }}</button>
                                        <hr>
                                    </form>
                                </div>
                            </div>
