...
@section('main-content')
    ...
    <div class="form-style-5">
        <form action="{{ url('/reviews/' . $review->id) }}" method="post" enctype="multipart/form-data">
            {{ method_field('PATCH') }}
            @csrf
            <fieldset>
                <legend><span class="number"><i class="fas fa-plus"></i></span> Edit Review of ({{ $review->employee->full_name }})</legend>
            </fieldset>
            <fieldset>
